app.objects.edge = function(from,to){
    ...
    this.draw = function(ctx){
        var self = this;
        app.algorithms.aaLine(this.from,this.to,ctx,self.relation.getColor().hex);
        //app.algorithms.drawBresenhamLine(this.from,this.to,ctx,self.relation.getColor().hex);
